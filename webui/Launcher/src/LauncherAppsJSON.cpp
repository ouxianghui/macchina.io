...
//
// This file has been generated from LauncherAppsJSON.cpsp on 2023-08-28 12:10:27.
//
...
#line 13 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
...
int i = 0;
	...
	responseStream << "\n";
	responseStream << "[\n";
#line 22 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
 for (AppRegistry::AppVec::const_iterator it = apps.begin(); it != apps.end(); ++it) { 	responseStream << "\n";
	responseStream << "  ";
#line 23 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
 if (it->permission.empty() || pAuthService->authorize(username, it->permission)) { 	responseStream << "\n";
	responseStream << "    ";
#line 24 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
	responseStream << ( i++ ? "," : "" );
	responseStream << "\n";
	responseStream << "  {\n";
	responseStream << "    \"id\": ";
#line 26 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
	responseStream << ( U::jsonize(it->id) );
	responseStream << ",\n";
	responseStream << "    \"title\": ";
#line 27 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
	responseStream << ( U::jsonize(it->title) );
	responseStream << ",\n";
	responseStream << "    \"icon\": ";
#line 28 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
	responseStream << ( U::jsonize(it->icon) );
	responseStream << ",\n";
	responseStream << "    \"tooltip\": ";
#line 29 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
	responseStream << ( U::jsonize(it->tooltip) );
	responseStream << ",\n";
	responseStream << "    \"link\": ";
#line 30 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
	responseStream << ( U::jsonize(it->path) );
	responseStream << "\n";
	responseStream << "  }\n";
	responseStream << "  ";
#line 32 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
 } 	responseStream << "\n";
#line 33 "/home/ubuntu/Documents/dev/macchina.io/webui/Launcher/src/LauncherAppsJSON.cpsp"
 } 	responseStream << "\n";
	responseStream << "]\n";
